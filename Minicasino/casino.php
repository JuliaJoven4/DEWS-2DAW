...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset ($_POST['accion'])) {
        if ($_POST['accion'] == 'apostar') {
            ...
            if ($_POST['dineroApuesta'] > $_SESSION['dinero']) {
                $msg = "No puede apostar más dinero del que tiene.";
                include 'apuesta.php';
            }
            else {
                    ...
                    if ($_POST['apuesta'] == $resultadoCasino) {
                        ...
                        if (is_numeric($_POST['dineroApuesta'])) {
                            ...
                            if ($_SESSION['dinero'] == 0) {
                                ...
                                $veces++;
                                setcookie('veces', $veces, time() + 60*60*24*30);
                            } else { include 'apuesta.php'; }
                        } else { $msg = "Debe introducir un importe para apostar."; include 'apuesta.php';}
                    }
                }
            }
