...
<table>
 ...
 <input type="text" 	name="DESCRIPCION" 	value="<?=$pro->DESCRIPCION ?>"        <?= ($orden == "Detalles")?"readonly":"" ?> size=10></td></tr>
 <tr><td>Precio </td> <td>
 <input type="text" name="PRECIO_ACTUAL" 	value="<?=$pro->PRECIO_ACTUAL ?>"        <?= ($orden == "Detalles")?"readonly":"" ?> size=20></td></tr>
 <tr><td>Stock </td><td>
 <input type="number" 	name="STOCK_DISPONIBLE" value="<?=$pro->STOCK_DISPONIBLE ?>" <?= ($orden == "Detalles")?"readonly":"" ?> size="20" autofocus></td></tr>
 </table>
